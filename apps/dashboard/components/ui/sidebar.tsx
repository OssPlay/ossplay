...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: the Cookie Store API isn't baseline-supported yet; this is a simple non-HttpOnly UI preference, not a security-sensitive cookie.
