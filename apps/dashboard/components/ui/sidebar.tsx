...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// (biome's suggested alternative) isn't supported in Firefox/Safari —
			// switching would silently drop persistence there, worse than the
			// lint warning.
			// biome-ignore lint/suspicious/noDocumentCookie: Cookie Store API has no Firefox/Safari support yet
