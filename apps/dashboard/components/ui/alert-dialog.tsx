...
// Both Action and Cancel close the dialog on click (base-ui's alert-dialog
// Close part) — Action additionally runs the caller's own handler first
// (e.g. the actual delete call) via onClick, same as shadcn's AlertDialog.
